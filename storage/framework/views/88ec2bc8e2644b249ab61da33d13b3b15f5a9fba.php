...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col">
        <div class="row">
            ...
            <div class="col product_page_col container order-first order-md-last">
                <div class="row">
                    <div class="col pb-5">
                        <form action="/svetilniki" method="GET" role="search">
    ...
    <section>
        <div>
            <p><?php echo e($mini_description); ?></p>
        </div>
    </section>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\master-D\resources\views/pages/category.blade.php ENDPATH**/ ?>
