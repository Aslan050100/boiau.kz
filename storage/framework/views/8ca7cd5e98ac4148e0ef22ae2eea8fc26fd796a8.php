                            ...
                            <div class="projects_item col-md-4">
                                ...
                                <a href="<?php echo e($cur_product->url); ?>">
                                    <div class="product_in_category">
                                        <h4 style="color: red;"><?php echo e(intval($score*100)); ?></h4>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boiau.kz1\resources\views/pages/product-detail-page.blade.php ENDPATH**/ ?>