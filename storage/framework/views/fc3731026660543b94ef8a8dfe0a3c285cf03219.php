    ...
    <section class="contact_area p_120">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <form class="row contact_form" action="https://Boiau CORP.kz/lead/mail.php" method="post" id="contactForm" novalidate="novalidate">
                        <div class="col-md-6">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\master-D\resources\views/pages/contact.blade.php ENDPATH**/ ?>